...
(function( root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        var isLicenseValid = options && new RegExp('([\\d\\w]{8}-){3}[\\d\\w]{8}|10901A56-DA2846FA-813CF5A6-940D57E7').test(options.licenseKey) || document.domain.indexOf('alvarotrigo.com') > -1;
